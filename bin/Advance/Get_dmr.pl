...
print OP "#chr\tpos_start\tpos_end\tshared_num\tmethy_in_normal\tmethy_in_tumor\tpos_num\ttumor_methy_num/tumor_NONE_methy_num\ttumor_methy_ratio\tnormal_methy_num/normal_NONE_methy_num\tnormal_methy_ratio\tchisq.test_p-value\tt.test_p-value\n";
